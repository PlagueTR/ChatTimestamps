...
public class GeneralOptionsScreen {
    ...
    public static ConfigBuilder getConfigBuilder() {
        ...
        ConfigBuilder builder = ConfigBuilder.create()
                ...
                .setTitle(new LiteralText("Plague's Chat Timestamps - General"));
        ...
        general.addEntry(entryBuilder.startBooleanToggle(new LiteralText("Disable Mod"), GeneralOptions.disableMod)
                .setDefaultValue(GeneralOptionsDefault.disableMod)
                .setTooltip(new LiteralText("Disables the mod. This will stop adding timestamps to chat."))
                .setSaveConsumer(newValue -> GeneralOptions.disableMod = newValue)
                .build());

        general.addEntry(entryBuilder.startStrField(new LiteralText("Timestamp Format"), GeneralOptions.timestampFormat)
        ...
        general.addEntry(entryBuilder.startTextDescription(
                new LiteralText("§7Timestamp Formatting Help\n" + mc_formatting_info + ts_formatting_info))
                .build());
